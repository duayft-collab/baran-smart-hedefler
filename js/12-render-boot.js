function renderPage(){
  var pages={
    dashboard:renderDashboard,kpi:renderKPI,today:renderDailyWorkspace,goals:renderGoals,goalsdash:renderGoalsDashboard,okr:renderOKR,analytics:renderAnalytics,
