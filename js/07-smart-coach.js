...
function del(id,type){
  ...
  var km={goal:'goals',todo:'todos',kpi:'kpis',journal:'journal',coaching:'coaching',question:'questions',vault:'vault',challenge:'challenges',mybook:'mybooks',sop:'sops',habit:'habits',gtd:'gtdInbox'};
  var key=km[type];
  if(!key||!D[key])return;
